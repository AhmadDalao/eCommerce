<section class="category_add_section py-5">
    <div class="container">
        <h1 class="text-center header_color text-capitalize mb-5"><?php echo lang("add_category"); ?></h1>
        <form method="POST" action="?action=insert"
            ...
            <div class="form-group position-relative  col-12 col-md-9 col-lg-6">
                ...
                <input type="number" class="form-control form-control-lg" name="ordering" id="CategoryOrdering">
            </div>
            ...
            <div class="form-group  position-relative col-12 col-md-9 col-lg-6">
                ...
                <!-- commentYes-->
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="commenting" id="commentYes" value="0" checked>
                ...
                <!-- commentNo -->
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="commenting" id="commentNo" value="1">
            ...
            <div class="form-group  position-relative col-12 col-md-9 col-lg-6">
                ...
                <!-- yes -->
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="advertisement" id="adsYes" value="0" checked>
                ...
                <!--  No -->
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="advertisement" id="adsNo" value="1">
            ...
            <div class="form-group col-12 col-md-9 col-lg-6">
                <input type="submit" class="btn btn-primary btn-lg text-capitalize"
                    value="<?php echo lang("add_category"); ?>">
            </div>
        </form>
    </div>
</section>
