<section class="manage_item py-5">
    <div class="container">
        ...
        <!-- Modal -->
        <div class="modal fade manageItem" data-targetedModal='manageItem' id="#manageItem" tabindex="-1"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p><?php echo lang('manageItem_modalWarning'); ?><span
                    ...
                    <div class="modal-footer">
                        ...
                        <a id="modal_deleteButton" class="btn btn-danger edit_delete_button text-capitalize"
                            data-page_url="items.php?action=delete&item_id="
