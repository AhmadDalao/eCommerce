                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown ">
                        <a class="nav-link dropdown-toggle text-capitalize  <?php if ($activePage == "categories") {
                                                                                echo "active";
                                                                            } ?>" href="#" id="categoriesDropDown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="categoriesDropDown">
                            ...
                            ?>
                                    <a class="dropdown-item text-capitalize" href="categories.php?cateID=<?php echo $category["ID"]; ?>&cateName=<?php echo str_replace(" ", "-", $category['name']); ?>">
                    ...
                    <li class="nav-item dropdown ">
                        <a class="nav-link dropdown-toggle text-capitalize" href="#" id="itemsFilter" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Filter items
                        </a>
                        ...
                        <li class="nav-item dropdown ">
                            <a class="nav-link dropdown-toggle text-capitalize" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="avatar-holder d-inline-block mr-1">
                                    <img class="img-fluid position-relative rounded-circle " src="layout/images/avatar5.png" />
                                </div>
                                <?php echo $userSession; ?>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item text-capitalize" href="profile.php?profileName=<?php echo $_SESSION['userFront']; ?>">Profile</a>
                                <?php if (isset($_SESSION['userFrontGroupID']) && ($_SESSION['userFrontGroupID'] == 2 || $_SESSION['userFrontGroupID'] == 1)) { ?>
                                    ...
                                    <a class="dropdown-item text-capitalize" href="profile.php?profileName=<?php echo $_SESSION['userFront']; ?>#userAds">My
                                        Items</a>
                                <?php } ?>
                                <a class="dropdown-item text-capitalize" href="#"><?php echo lang("navbar_settings_dashboard"); ?></a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-capitalize" href="logout.php"><?php echo lang("navbar_logout_dashboard") ?></a>
                            </div>
                        </li>
                    <?php } else {  ?>
